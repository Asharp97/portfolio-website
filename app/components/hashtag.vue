<template>
  <div
    ...
    :class="[
      ...
      'group-hover:p-1 group-hover:rotate-90 group-hover:bg-copper-500 hover:bg-copper-500 hover:scale-125 hover:-translate-x-1',
    ]">
    <Icon
      name="majesticons:hashtag-line"
      class="duration-300 transition-all animate-spin"
      :class="[
